...
import { useActiveStockModal, useAddStockModal, useDeleteStockModal } from "@/hooks/useStock";
                ...
                {listStock.map((stock, index) => {
                    ...
                    return (
                        <tr key={index}>
                            ...
                            <td className="py-3 border-r border-black border-opacity-10">{stock.quantity}</td>
